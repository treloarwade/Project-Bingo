...
public class financeGrass : MonoBehaviour
{
#pragma warning disable CS0414 // The field 'financeGrass.isWiggling' is assigned but its value is never used
    private bool isWiggling;
#pragma warning restore CS0414 // The field 'financeGrass.isWiggling' is assigned but its value is never used
    ...
    private void Start()
    {
        ...
        dingos = new List<DingoID>(DingoDatabase.financeDingos);
    }
